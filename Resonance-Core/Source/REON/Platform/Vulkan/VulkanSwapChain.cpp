...
namespace REON
{
VulkanSwapChain::VulkanSwapChain(VulkanContext& ctx, VkDevice& dev) : m_Context(ctx), m_device(dev) {}
...
void VulkanSwapChain::init()
{
    ...
    createInfo.imageUsage = VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT; // TODO: CHECK IF THIS NEEDS TO BE CHANGED FOR ADDING
                                                                 // POST PROCESSING/RENDERING TO SCENE TAB
    ...
    m_swapchainSurfaceFormat.surfaceFormat = surfaceFormat;
    m_Extent = extent;
    ...
    {
        m_Views[i] = m_Context.createImageView(m_Images[i], m_swapchainSurfaceFormat.surfaceFormat.format,
...
/*SwapChainSupportDetails VulkanSwapChain::querySwapChainSupport(VkPhysicalDevice device)
{
    ...
    if (presentModeCount != 0) {
        ...
        vkGetPhysicalDeviceSurfacePresentModesKHR(device, m_Context.getSurface(), &presentModeCount,
