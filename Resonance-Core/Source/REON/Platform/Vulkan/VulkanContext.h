...
class VulkanContext : public RenderContext
{
  public:
    ...
    {
        return m_physDevices.Selected().m_physDevice;
    }
    ...
    size_t getAmountOfSwapChainImages() const
    {
    ...
    void createCommandBuffers(std::vector<VkCommandBuffer>& commandBuffers, size_t amountOfBuffers) const;
  ...
  private:
    ...
    const std::vector<const char*> m_DeviceExtensions = {
        VK_KHR_SWAPCHAIN_EXTENSION_NAME, VK_KHR_DEPTH_STENCIL_RESOLVE_EXTENSION_NAME,
        VK_KHR_SHADER_DRAW_PARAMETERS_EXTENSION_NAME, VK_EXT_EXTENDED_DYNAMIC_STATE_3_EXTENSION_NAME
