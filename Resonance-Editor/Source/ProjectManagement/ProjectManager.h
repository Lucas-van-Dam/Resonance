...
class ProjectManager
{
  ...
  private:
    ...
    template <typename T> void RegisterDeserializer(const std::string& name, std::function<T(const std::string&)> func)
    {
    ...
    template <typename T> T Deserialize(const std::string& name, const std::string& str)
    {
